"""Prompts for policy, controls and gap analysis"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/Helper/prompts.ipynb.

# %% auto 0
__all__ = ['controls_prompt_template', 'policy_prompt_template', 'policy_gap_all_domain_prompt_template',
           'policy_gap_prompt_template', 'policy_gap_output']

# %% ../../../nbs/Helper/prompts.ipynb 2
from langchain.prompts import PromptTemplate

# %% ../../../nbs/Helper/prompts.ipynb 3
##
## Control's Prompt template for extracting headings and subheadings
##
...
# %% ../../../nbs/Helper/prompts.ipynb 4
##
## Policy's prompt template for extracting headings and subheadings
##
...
policy_prompt_template = PromptTemplate(
    ...
    template="""
    Role:
    Expert Policy Analyst specializing in {region} {industry} GRC  
    ...
    Task:
        ...
        **Make sure policy should specific to  {region} region and {industry} industry**

        "GENERATE OUTPUT INTO MARKDOWN FORMAT"

    """
)

# %% ../../../nbs/Helper/prompts.ipynb 5
##
